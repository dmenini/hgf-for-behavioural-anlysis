...
est_ideal = tapas_fitModel([],...
        inputs.u,...
        'tapas_hgf_binary_config_',...
        'tapas_bayes_optimal_binary_config',...
        'tapas_quasinewton_optim_config');
    
mu_0 = est_ideal.p_prc.mu_0;
om = est_ideal.p_prc.om;
...
sim_ideal = tapas_simModel(inputs.cues,...
                     ...
                     5,...
                     12345);
score_ideal = sum(sim_ideal.y == sim_ideal.u)/120
...
sim_healthy = tapas_simModel(inputs.cues,...
                     ...
                     5,...
                     12345);
score_healthy = sum(sim_healthy.y == sim_healthy.u)/120
...
sim_anxious = tapas_simModel(inputs.cues,...
                     ...
                     5,...
                     12345);                 
score_anxious = sum(sim_anxious.y == sim_anxious.u)/120
